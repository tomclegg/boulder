...
func (wfe *WebFrontEndImpl) HandleFunc(pattern string, h func(http.ResponseWriter, *http.Request), methods ...string) {
...
func (wfe *WebFrontEndImpl) HandlePaths() {
	...
	wfe.HandleFunc("/", wfe.Index, "GET")
	wfe.HandleFunc(NewRegPath, wfe.NewRegistration, "POST")
	wfe.HandleFunc(NewAuthzPath, wfe.NewAuthorization, "POST")
	wfe.HandleFunc(NewCertPath, wfe.NewCertificate, "POST")
	wfe.HandleFunc(RegPath, wfe.Registration, "POST")
	wfe.HandleFunc(AuthzPath, wfe.Authorization, "GET", "POST")
	wfe.HandleFunc(CertPath, wfe.Certificate, "GET", "POST")
	wfe.HandleFunc(RevokeCertPath, wfe.RevokeCertificate, "POST")
	wfe.HandleFunc(TermsPath, wfe.Terms, "GET")
	wfe.HandleFunc(IssuerPath, wfe.Issuer, "GET")
	wfe.HandleFunc(BuildIDPath, wfe.BuildID, "GET")
}
